...
void Sample() {
    ...
    auto neural_network = NeuralNetwork<double>(std::make_unique<Optimizer<double>>(0.01), std::make_unique<MSELoss<double>>());
...
void DigitRecognizer(const std::string& data_path, const std::string& output, std::unique_ptr<IOptimizer<double>> optimizer) {
...
//    Mnist(data_path);
//    DigitRecognizer(data_path, "predictions-sgd-0.001.csv", std::make_unique<Optimizer<double>>(0.0001));
//    DigitRecognizer(data_path, "predictions-momentum-0.01.csv", std::make_unique<MomentumOptimizer<double>>(0.0001, 0.0001));
    DigitRecognizer(data_path, "predictions-rmsprop-0.01-40.csv", std::make_unique<RMSPropOptimizer<double>>(0.01));
//    DigitRecognizer(data_path, "predictions-adam-0.01.csv", std::make_unique<AdamOptimizer<double>>(0.01));
//    DigitRecognizer(data_path, "predictions-adam-0.001.csv", std::make_unique<AdamOptimizer<double>>(0.001));
//    DigitRecognizer(data_path, "predictions-adam-0.0001.csv", std::make_unique<AdamOptimizer<double>>(0.0001));
//    Sample();
    return 0;
}